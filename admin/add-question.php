...
<div class="container mt-4">
    <div class="row">
        ...
        <div class="col-6 mb-3 d-flex align-items-end">
            ...
            <button type="button" class="btn btn-outline-primary ms-2" data-bs-toggle="modal" data-bs-target="#addTestModal">
        ...
        <div class="col-6 mb-3 d-flex align-items-end">
            ...
            <button type="button" class="btn btn-outline-primary ms-2" data-bs-toggle="modal" data-bs-target="#addDepartmentModal">
                <i class="bi bi-plus"></i>
            </button>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    $('#save-new-test').on('click', function() {
        ...
        if (testName && departmentId) {
            $.post('add_test.php', { test_name: testName, department_id: departmentId }, function(response) {
    ...
    $('#save-new-department').on('click', function() {
        ...
        if (departmentName) {
            $.post('add_department.php', { department_name: departmentName }, function(response) {
                if (response.status === 'success') {
